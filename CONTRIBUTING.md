...
Implementation decisions and code changes are handled by the project maintainer.

Discussions, ideas, and suggestions, however are always welcome.

This policy may change in the future as the project becomes more stable.
...
`maturity` is currently under active development.
Some APIs, behaviours, and plans may change between releases as experimentation and real-world usage shape the project.
